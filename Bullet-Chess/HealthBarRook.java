 ...
 * 
 */
public class HealthBarRook extends Actor
{
    private int health;
    ...
    public HealthBarRook(int maxHealth)
    {
        ...
        public void updateHealthBar()
    {
        ...
        GreenfootImage fontImage = new GreenfootImage("The First Rook Lord", 20, Color.WHITE, null);
