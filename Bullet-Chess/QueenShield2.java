 ...
 * 
 */
public class QueenShield2 extends QueenPhase2
{
    private int centerX;  
    private int centerY;  
    private float angle;  
    ...
    public QueenShield2(int centerX, int centerY, float radius, float speed) {
    ...
    public void act()
    {
        angle += speed2 * Math.PI / 180; 
        int bulletX = centerX + (int)(radius2 * Math.cos(angle));
        int bulletY = centerY + (int)(radius2 * Math.sin(angle));
