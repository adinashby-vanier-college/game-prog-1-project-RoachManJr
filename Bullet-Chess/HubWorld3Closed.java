 ...
 * 
 */
public class HubWorld3Closed extends World
{
    private Player player;
    /**
     * Constructor for objects of class HubWorld3Closed.
     */
    public HubWorld3Closed()
    {
        super(800, 800, 1);
        prepare();
    }
    ...
    private void prepare()
    {
        ...
        addObject(roofedClosedDoor,483,72);
        ...
        DoorTrigger3 trig = new DoorTrigger3();
