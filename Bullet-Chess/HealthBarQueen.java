...
public class HealthBarQueen extends Actor
{
    private int health;
    ...
    public HealthBarQueen(int maxHealth)
    {
        ...
        public void updateHealthBar()
    {
        ...
        GreenfootImage fontImage = new GreenfootImage("Caïssa, the Goddess of Chess", 20, Color.WHITE, null);
