...
import java.util.*;
/**
 * Write a description of class DoorTrigger2Challenge here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class DoorTrigger2Challenge extends Actor
{
    ...
    public void act() {
        ...
        if (isTouching(Player.class)) {
            ...
            if (!playerInPortal) {
                ...
                FadeTransitionChallenge2 fade = new FadeTransitionChallenge2();
