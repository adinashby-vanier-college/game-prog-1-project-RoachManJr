...
import java.util.*;
/**
 * Write a description of class DoorTrigger3ChallengeM here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class DoorTrigger3ChallengeM extends Actor
{
    ...
    public void act() {
        ...
        if (isTouching(Player.class)) {
            ...
            if (!playerInPortal) {
                ...
                FadeTransitionChallenge3M fade = new FadeTransitionChallenge3M();
