...
import java.util.*;
/**
 * Write a description of class DoorTrigger2ChallengeP here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class DoorTrigger2ChallengeP extends Actor
{
    ...
    public void act() {
        ...
        if (isTouching(Player.class)) {
            ...
            if (!playerInPortal) {
                ...
                FadeTransitionChallenge2P fade = new FadeTransitionChallenge2P();
