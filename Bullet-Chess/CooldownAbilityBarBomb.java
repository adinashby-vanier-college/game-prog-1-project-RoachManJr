...
public class CooldownAbilityBarBomb extends Actor
{
    ...
    public CooldownAbilityBarBomb(int maxCooldown)
    {
        ...
        public void updateCooldownBar()
    {
        ...
        GreenfootImage fontImage = new GreenfootImage("Bomb", 20, Color.WHITE, null);
