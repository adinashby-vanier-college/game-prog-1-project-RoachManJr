...
import java.util.*;
/**
 * Write a description of class DoorTrigger1Challenge1 here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class DoorTrigger1Challenge1 extends Actor
{
    ...
    public void act() {
        ...
        if (isTouching(Player.class)) {
            ...
            if (!playerInPortal) {
                ...
                FadeTransitionChallenge1_1 fade = new FadeTransitionChallenge1_1();
