...
import java.util.*;
/**
 * Write a description of class DoorTrigger3ChallengeP here.
 * 
 * @author (your name) 
 * @version (a version number or a date)
 */
public class DoorTrigger3ChallengeP extends Actor
{
    ...
    public void act() {
        ...
        if (isTouching(Player.class)) {
            ...
            if (!playerInPortal) {
                ...
                FadeTransitionChallenge3P fade = new FadeTransitionChallenge3P();
