...
public class HealthBarKnight extends Actor
{
    private int health;
    ...
    public HealthBarKnight(int maxHealth)
    {
        ...
        public void updateHealthBar()
    {
        ...
        GreenfootImage fontImage = new GreenfootImage("The Royal Knight", 20, Color.WHITE, null);
        int textX = (BAR_WIDTH - fontImage.getWidth()) / 13;
        int textY = (BAR_HEIGHT - fontImage.getHeight()) / 13;
