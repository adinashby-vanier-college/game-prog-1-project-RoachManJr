...
public class CooldownAbilityBarTriple extends Actor
{
    ...
    public CooldownAbilityBarTriple(int maxCooldown)
    {
        ...
        public void updateCooldownBar()
    {
        ...
        GreenfootImage fontImage = new GreenfootImage("Triple", 20, Color.WHITE, null);
